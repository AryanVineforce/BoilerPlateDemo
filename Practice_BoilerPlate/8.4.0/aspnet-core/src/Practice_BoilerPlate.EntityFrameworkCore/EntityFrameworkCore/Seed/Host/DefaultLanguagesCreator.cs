...
namespace Practice_BoilerPlate.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Practice_BoilerPlateConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Practice_BoilerPlateDbContext context)
        {
            _context = context;
        }
