...
import { GetSubjectDto, TeacherSubjectGetDto, TeacherSubjectServiceProxy } from '@shared/service-proxies/service-proxies';
...
import { EditTeacherDialogComponent } from "@app/teacher/edit-teacher/edit-teacher-dialog.component";
  ...
  teachersubjects: TeacherSubjectGetDto[] = [];
   ...
   constructor(
     ...
     createDepartment(): void {
      ...
      (createDialog.content as CreateTeachersubjectDialogComponent).onSave.subscribe(() => {
             this.refresh();
           });
     }
       ...
       editDepartment(subject: TeacherSubjectGetDto): void {
         ...
         (editDialog.content as EditTeacherSubjectDialogComponent).onUpdate.subscribe(() => {
            this.refresh();
          });
       }
