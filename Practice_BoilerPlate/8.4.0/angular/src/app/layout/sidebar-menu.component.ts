    ...
    getMenuItems(): MenuItem[] {
        return [
            ...
            new MenuItem(this.l('Academics'), '', 'fas fa-circle', '', [
                    ...
                    new MenuItem(this.l('TeacherSubject'), '/app/teachersubject', 'fas fa-clipboard-list')
                ]),
                ...
                new MenuItem(this.l('Students'), '', 'fas fa-users', '', [
                    new MenuItem(this.l('Students'), '/app/student', 'fas fa-user-graduate')
                ]),
                new MenuItem(this.l('Utilities'), '', 'fas fa-users', '', [
                    new MenuItem(this.l('File Uplaod'), '/app/fileupload', 'fas fa-plus'),
                ]),
            ]
